package br.com.ada.designpatterns.comportamentais.templatemethod.problema;
...
public class ReparVeiculoComumService {
    ...
    private boolean veiculoParaReparo() {return veiculoParaReparo.getPorcentagemDano() <= 70;}
    ...
    private void entradaOficina() {System.out.println("Veículo entrando na oficina...");}
}
