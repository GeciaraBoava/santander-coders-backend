package br.com.ada.designpatterns.estruturais.adapter.problema;
...
public class TesteOperacoesContaCorrente {
    public static void main(String[] args) {
        ...
        if (client.validaSaldo(valorPretendidoParaSaque)) { //validando saldo do cliente antes de sacar
